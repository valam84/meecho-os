...
#include "pfilter.h"
#ifdef __minix
/* MEECHO: blocklistd в системе нет. У файла для этого есть свой режим
 * SMALL, в котором обе точки входа - пустышки; включается он здесь, а не
 * снаружи, чтобы не задеть другие файлы. */
#define SMALL
#endif
#ifndef SMALL
#include <blocklist.h>
