...
# корень поднялся: сетевой стек и его драйвер. libexec - потому что там, а
# не в usr/libexec, живут dhcpcd-run-hooks и каталог его хуков: без них
# клиент получает аренду и не пишет resolv.conf, причём молча. Загрузочные серверы описаны в
