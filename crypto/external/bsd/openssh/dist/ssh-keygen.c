...
/* MEECHO: __dead здесь неверен - функция доходит до конца и возвращается,
 * а вызывающий (ssh-keygen.c, "do_ca_sign(...); goto done;") на это
 * рассчитывает. GCC 15 ловит противоречие как ошибку. */
static void
